...
class CapacitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create capacity" do
    assert_difference('Capacity.count') do
      post capacities_url, params: { capacity: { month: @capacity.month, percentage: @capacity.percentage, sector_id: @capacity.sector_id, year: @capacity.year } }
    end
  ...
  test "should update capacity" do
    patch capacity_url(@capacity), params: { capacity: { month: @capacity.month, percentage: @capacity.percentage, sector_id: @capacity.sector_id, year: @capacity.year } }
